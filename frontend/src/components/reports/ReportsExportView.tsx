      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-2xs space-y-4 max-w-xl">
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-slate-300 rounded-xl text-xs font-bold focus:ring-2 focus:ring-[#1B5E20] focus:outline-none cursor-pointer"
          >
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-slate-300 rounded-xl text-xs focus:ring-2 focus:ring-[#1B5E20] focus:outline-none"
            />
          </div>
          <div>
        ...
        <div className="pt-2 flex items-center gap-3">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-[#1B5E20] hover:bg-[#123D18] text-white font-bold text-xs rounded-xl transition cursor-pointer shadow-xs"
          >
