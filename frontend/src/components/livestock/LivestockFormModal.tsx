      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full overflow-hidden shadow-2xl border border-slate-200 flex flex-col max-h-[90vh]">
        ...
        <div className="p-4 bg-[#0A3D26] text-white flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-[#EEF2F0]">Isi formulir pendaftaran ternak ke master database</p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-1.5">
                <label className="flex items-center justify-center gap-1 px-2 py-1.5 rounded-lg bg-[#0A3D26] text-white text-[10px] font-bold cursor-pointer hover:bg-[#0F5132]">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3 py-1.5 border border-slate-300 rounded-lg text-xs font-mono font-bold focus:ring-2 focus:ring-[#0F5132] focus:outline-none"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-1.5 border border-slate-300 rounded-lg text-xs font-semibold focus:ring-2 focus:ring-[#0F5132] focus:outline-none"
                  >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 border border-slate-300 rounded-lg text-xs focus:ring-2 focus:ring-[#0F5132] focus:outline-none"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-2 border-t border-slate-200">
            <div>
              ...
              <select
                ...
                required
                className="w-full px-3 py-1.5 border border-slate-300 rounded-lg text-xs font-bold focus:ring-2 focus:ring-[#0F5132] focus:outline-none"
              >
                {locations.map(loc => (
