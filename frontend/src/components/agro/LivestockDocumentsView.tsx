    ...
    <div className="space-y-5 pb-16">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="flex gap-2 rounded-2xl border bg-white p-1">
          <button onClick={() => setTab('peternakan')} className={`rounded-xl px-4 py-2 text-xs font-black ${tab === 'peternakan' ? 'bg-[#5a2d1f] text-white' : 'text-slate-500'}`}>Peternakan Sapi</button>
