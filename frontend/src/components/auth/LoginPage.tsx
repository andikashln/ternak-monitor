    ...
    <main className="min-h-screen bg-[#EFE5D5] text-[#24150F] lg:grid lg:grid-cols-[1.05fr_0.95fr]">
      <section className="relative hidden overflow-hidden bg-[#5A2D1F] px-12 py-14 text-[#FBF8F2] lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div>
            <p className="text-xl font-black tracking-tight">PT.DUTA AGRO NUSANTARA</p>
      ...
      <section className="flex min-h-screen items-center justify-center px-5 py-10 sm:px-10">
        <div className="w-full max-w-md">
          <div className="mb-8 flex items-center gap-3 lg:hidden">
            ...
            <div>
              <p className="font-black tracking-tight">PT.DUTA AGRO NUSANTARA</p>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/5 sm:p-9">
            ...
            <p className="mt-2 text-center text-[11px] text-slate-500">Masuk ke data contoh PT.Duta Agro Nusantara tanpa mengisi akun.</p>
          ...
          <p className="mt-6 text-center text-[11px] text-slate-400">© 2026 PT.Duta Agro Nusantara · Ternak Monitor</p>
        </div>
      </section>
    </main>
  );
