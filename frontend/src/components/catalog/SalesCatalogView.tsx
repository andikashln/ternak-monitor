      ...
      <section className="overflow-hidden rounded-3xl bg-[#123b2b] p-6 text-white shadow-xl sm:p-8">
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div className="max-w-2xl">
            ...
            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Temukan sapi pilihan dari PT.DUTA AGRI NUSANTARA</h1>
          ...
          <div className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-xs font-semibold text-[#F8FAFC]">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="relative w-full sm:max-w-sm">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-300 py-2.5 pl-9 pr-3 text-xs outline-none focus:border-[#1B5E20] focus:ring-4 focus:ring-[#1B5E20]/10"
            />
          </div>
        </div>
              ...
              <article key={item.id} className="overflow-hidden rounded-2xl border border-slate-200 bg-white transition hover:-translate-y-0.5 hover:shadow-lg">
                <div className="relative h-52 bg-gradient-to-br from-[#FFFFFF] to-slate-100">
                  {item.photoUrl ? (
                    ...
                    <div className="flex h-full flex-col items-center justify-center text-[#123D18]/45">
                ...
                <div className="space-y-3 p-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs text-slate-600">
                    <span className="flex items-center gap-1.5"><Scale className="h-3.5 w-3.5 text-[#1B5E20]" /> {item.currentWeightKg} kg</span>
                    <span className="flex items-center gap-1.5"><MapPin className="h-3.5 w-3.5 text-[#1B5E20]" /> {item.locationName}</span>
