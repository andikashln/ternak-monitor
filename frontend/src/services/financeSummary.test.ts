...
const transactions: FinancialTransaction[] = [
  {
    ...
    description: 'Penjualan', locationId: 'loc-main', locationName: 'Sapi Farm Riau', amount: 30_000_000,
  ...
  },
  {
    ...
    description: 'Harga beli/HPP ternak terjual (INV-08)', locationId: 'loc-main', locationName: 'Sapi Farm Riau', amount: 20_000_000,
  ...
  },
  {
    ...
    description: 'Pakan', locationId: 'loc-main', locationName: 'Sapi Farm Riau', amount: 2_000_000,
  ...
  },
  {
    ...
    description: 'Penjualan lama', locationId: 'loc-main', locationName: 'Sapi Farm Riau', amount: 10_000_000,
...
const sales: SalesRecord[] = [
  {
    ...
    locationId: 'loc-main', locationName: 'Sapi Farm Riau', salesRep: 'Owner', transactionStatus: 'Selesai', createdBy: 'Owner', createdAt: '2026-08-12T00:00:00.000Z',
  },
];
